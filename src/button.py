...
# IMG_BASE = ''
...
class ButtonBase(Label):
  def __init__(self, parent, text, images=[], command=None, fg='white', bg=None):
    ...
    for i, img in enumerate( images): self.images.append(self._render_img(img, factors[i]))
