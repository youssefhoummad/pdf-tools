...
from .itemSidebare import ItemSidebare
from .cardFrame import CardFrame
from .button import Button, ButtonSmall
from .toggleSwitch import Switch
from .imageLabel import ImageLabel
from .browseForm import BrowseForm, BrowseForm2
from .linkLabel import LinkLabel
from .entry import EntryWithPlusMinus
...
class AppGui(tk.Frame):
  ...
  def init_sidebar(self):
    ...
    menu = [
      {'title':SPLIT_TITLE,'icon':r'D:\\برمجة\\pdf\\img\\cut.png', 'index':0},
      {'title':MERGE_TITLE,'icon':r'D:\\برمجة\\pdf\\img\\merge.png', 'index':1 },
      {'title':CROP_TITLE,'icon':r'D:\\برمجة\\pdf\\img\\crop.png', 'index':2 },
      {'title':EXTRACT_TITLE,'icon':r'D:\\برمجة\\pdf\\img\\image.png', 'index':3 },
      {'title':IMAGES_TITLE,'icon':r'D:\\برمجة\\pdf\\img\images.png', 'index':4 },
      {'title':ABOUT_TITLE, 'icon':r'D:\\برمجة\\pdf\\img\\info.png', 'index':5}
      ]
    # show top <PDF-Tools>
  ...
  def split_screen(self):
    ...
    header = ImageLabel(_f, r'D:\\برمجة\\pdf\\img\\split_header.png',width=550, height=180)
    header.pack()
    ...
    GifLabel(_f, r'D:\\برمجة\\pdf\\img\\loading_blue.gif').pack(side=START_DIR, anchor='sw', pady=(0,2))
    return _f
  ...
  def merge_screen(self):
    ...
    header = ImageLabel(_f, r'D:\\برمجة\\pdf\\img\\merge_header.png',width=550, height=180)
    header.pack()
  ...
  def extract_screen(self):
    ...
    header = ImageLabel(_f, r'D:\\برمجة\\pdf\\img\\extract_header.png',width=550, height=180)
    header.pack()
  ...
  def to_pdf_screen(self):
    ...
    header = ImageLabel(_f, r'D:\\برمجة\\pdf\\img\\to_pdf_header.tif',width=550, height=180)
    header.pack()
