...
IMAGES_TITLE = "Convert to images"
ABOUT_TITLE = "ABOUT"
...
IMAGES_DESC = "Convert each PDF page into a JPG."
...
#   MAIN_DESC = "أدوات PDF هي مجموعة من الأدوات\nالتي تعمل بشكل جيد مع ملفات البي.دي.اف"

#   SPLIT_TITLE = "تقطيع الملفات"
#   MERGE_TITLE = "دمج الملفات"
#   CROP_TITLE = "إزالة هوامش الملفات"
#   EXTRACT_TITLE = "استخراج الصور"
#   IMAGES_TITLE = "تحويل الملف لصور"
#   ABOUT_TITLE = "حول"
